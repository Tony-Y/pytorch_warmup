...
ewf = {
    ...
    8: 3 * math.sqrt(38610293903545800493859693214989542002076301625518651)
    / 648745826249577848268496415,
    9: 3 * math.sqrt(12026080263946093429637752207887183661294840713819813)
    / 353035787321509409011021039,
    10: 3 * math.sqrt(456865593113897246792694328842050091932272202605586577311)
    / 67546148486329926220639511801,
}  # fmt: skip
...
class TestRAdam(unittest.TestCase):
    ...
    def test_radam(self) -> None:
        ...
        _test_state_dict(self, warmup_scheduler, lambda: warmup.RAdamWarmup(optimizer))
